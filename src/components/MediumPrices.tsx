...
interface MediumPricesProps {
  mediumPrizes: GameType[];
}

const MediumPrices = ({ mediumPrizes }: MediumPricesProps) => {
  ...
  return (
    <section className="px-5 flex flex-col gap-6  relative">
      <h1 className="text-[30px] text-[white] ">MEDIUM PRICES</h1>
